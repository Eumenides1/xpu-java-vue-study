...
public class MPGenerate {
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.rookie.stack.demo");//自定义包的路径
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://gz-cynosdbmysql-grp-ohj017lr.sql.tencentcdb.com:23186/xpu_springboot_demo?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
